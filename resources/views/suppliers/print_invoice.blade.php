...
<div class="l-col-right ticket-wrap" aria-label="A fake boat ticket demonstrating mixing font weights and widths">
  <div class="ticket" aria-hidden="true">
    ...
    <div class="ticket__body">
      <p class="ticket__route">'.$data->suppliers->prefix.' '.$data->suppliers->firstName.' '.$data->suppliers->lastName.' '.$data->suppliers->suffix.' </p>
      <p class="ticket__description">'.$data->suppliers->title.'</p>
      <p class="ticket__description">'.$data->suppliers->companyName.', '.$data->suppliers->nations->iso.'</p>
      <div class="ticket__timing">
        ...
        <p>
          ...
          <span class="ticket__detail">06:00 - 09:30 pm</span>
        </p>
      </div>
